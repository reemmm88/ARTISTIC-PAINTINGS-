  ...
  <div class="card-body text-center">
    ...
    <center>
      <form method="post" action="https://www.sandbox.paypal.com/cgi-bin/webscr">
        ...
        <input type="image" name="submit" width="500" height="270" src="assets/images/mada.png">
        <input type="image" name="submit" width="500" height="270" src="assets/images/apple-pay.jpg">
