...
if (isset($_GET['cat_id'])) {
	...
	$row_p_cats = $getFromU->getAllByID("categories", $cat_id);
...
?>
	...
	<div class="row">
		<?php
		$get_products_by_cat_id = $getFromU->selectAllProductBycat_id($start_from, $per_page, $cat_id);
			...
			<ul class="pagination mx-auto">
				...
				?>
					<li class="page-item <?php if ($_GET['page'] == 1) {
												echo 'active';
											} ?>"><a class="page-link" href="shop.php?page=1">First Page</a></li>
					<?php
					for ($i = 2; $i < $total_pages; $i++) {
					?>
						<li class="page-item <?php if ($_GET['page'] == $i) {
													echo 'active';
												} ?>"><a class="page-link" href="shop.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php } ?>
					<li class="page-item <?php if ($_GET['page'] == $total_pages) {
												echo 'active';
											} ?>"><a class="page-link" href="shop.php?page=<?php echo $total_pages; ?>">Last Page</a></li>
				<?php } ?>
